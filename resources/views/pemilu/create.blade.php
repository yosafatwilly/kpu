                ...
                <form method="POST" action="{{ route('pemilu.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="periode" class="form-control border-input" value="{{ old('periode') }}" required="true" placeholder="Periode">
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class='input-group date'>
                                            <input type='text' class="form-control datetimepicker" value="{{ old('start_daftar') }}" name="start_daftar" placeholder="Start Date" />
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <h6>Sampai</h6>
                                        <div class='input-group date'>
                                            <input type='text' class="form-control datetimepicker" value="{{ old('end_daftar') }}" name="end_daftar" placeholder="End Date" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                            </span>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class='input-group date'>
                                            <input type='text' class="form-control datetimepicker" value="{{ old('start_pemilu') }}" name="start_pemilu" placeholder="Start Date" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                            </span>
                                        </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <h6>Sampai</h6>
                                        <div class='input-group date'>
                                            <input type='text' class="form-control datetimepicker" value="{{ old('end_pemilu') }}" name="end_pemilu" placeholder="End Date" />
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                            </span>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            ...
                            <div class="form-group">
                                <input type="text" name="angkatan_ketua[]" class="form-control border-input" value="{{ old('angkatan_ketua.0')}}"  required="true" placeholder="Angkatan">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="angkatan_wakil[]" value="{{ old('angkatan_wakil.0')}}" class="form-control border-input" required="true" placeholder="Angkatan">
                            </div>
                            <div class="form-group">
                                <h6>Program Studi <span class="icon-danger">*</span></h6>
                            ...
                            <div class="form-group">
                                <h6>Visi</h6>
                                <textarea class="form-control" name="visi[]"  placeholder="Visi" rows="13" maxlength="150" >{{ old('visi.0')}}</textarea>
                            </div>
                            <div class="form-group">
                                <h6>Misi</h6>
                                <textarea class="form-control" name="misi[]" placeholder="Misi" rows="13" maxlength="150" >{{ old('misi.0')}}</textarea>
                            </div>
                        </div>
                    </div>
                    <hr>
